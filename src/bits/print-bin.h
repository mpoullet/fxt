...
// Copyright (C) 2010, 2011, 2018 Joerg Arndt
...
// bits/print-bin.cc:
void print_bin(const char *bla, unsigned long long x, ulong pd=0, const char *c01=nullptr);
void print_bin_vec(const char *bla, unsigned long long x, ulong pd=0, const char *c01=nullptr);
