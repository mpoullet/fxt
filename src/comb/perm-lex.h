...
// Copyright (C) 2010, 2011, 2012, 2013, 2014, 2015, 2019 Joerg Arndt
...
#define PERM_LEX_FIXARRAYS // default on (great speedup)

// define to use easy case optimization:
#define PERM_LEX_OPT // default on (speedup)
...
private:  // have pointer data
    perm_lex(const perm_lex&) = delete;
    perm_lex & operator = (const perm_lex&) = delete;
